...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("3", "PHIẾU GIẢM GIÁ", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "PHIẾU GIAO HÀNG", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("12", "THỐNG KÊ", Model_Menu.MenuType.MENU));
