...
public class PhieuGiamGiaReposity {
    ...
    String sql = "select *from PhieuGiamGia join GiamGiaTheoSP on PhieuGiamGia.ID_SP = GiamGiaTheoSP.ID_SP "
   ...
   public Integer SAVE(PhieuGiamGia G){
        ...
        Connection cn = DBContext.getConnection();
        String sql = "INSERT INTO PhieuGiamGia (ID_SP, NgayBatDau, NgayHH, GiaTriGG, TrangThai,MOTA) VALUES (?,?,?,?,?,?,?)";
