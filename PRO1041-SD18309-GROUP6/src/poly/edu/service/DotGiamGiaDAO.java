...
public class DotGiamGiaDAO implements Interface_DotGiamGia {
    ...
    public Integer add(DotGiamGia dgg) {
        Integer row = null;
        String sql = "INSERT INTO DotGiamGia( TenNDGG, NgayBatDau, NgayKetThuc,LoaiGiamGia, GiaTriGG, DieuKienGiamGia, MoTa) VALUES (?,?,?,?,?,?,?)";
        Connection con = DBContext.getConnection();
        try {
            PreparedStatement pr = con.prepareStatement(sql);
    ...
    public Integer update(DotGiamGia dgg) {
        Integer row = null;
        String sql = "UPDATE DotGiamGia SET TeNDGG = ?, NgayBatDau = ?, NgayKetThuc = ?,LoaiGiamGia = ?, GiaTriGG = ?, DieuKienGiamGia= ?, MoTa = ? WHERE MaDGG =?";
        Connection con = DBContext.getConnection();
        try {
            PreparedStatement pr = con.prepareStatement(sql);
