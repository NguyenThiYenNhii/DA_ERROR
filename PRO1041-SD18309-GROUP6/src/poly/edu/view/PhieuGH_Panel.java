...
public class PhieuGH_Panel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(919, 574));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(cboloc, 0, 175, Short.MAX_VALUE))
...
//        gh1.setMaGH(Integer.parseInt(txtphieugh.getText()));
        ...
        gh1.setTtGH(rdodanggiao.isSelected() ? "Đang Giao" : "Đã Giao");
    ...
    private void update() {
        try {
            int chon = JOptionPane.showConfirmDialog(this, "Bạn muốn sua phieu giao hang?");
            if (chon != JOptionPane.YES_OPTION) {
                return;
            }
            PhieuGiaoHang giao = readForm();
            if (gh.updateGH(giao) != null) {
            ...
            JOptionPane.showMessageDialog(this, "Sua loi");
            e.printStackTrace();
        }
    }
    ...
    private void delete() {
        try {
            ...
            if (gh.deleteGH(index, maGH) != null && index >= 0) {
//                mol.removeRow(index);
    ...
    private void find() {
        ...
        mol.setRowCount(0);
        for (PhieuGiaoHang giao : gh.selectById(sdt)) {
            mol.addRow(new Object[]{
                giao.getMaGH(),
                giao.getSDT(),
                giao.getTenNV(),
                ...
                giao.getNgayGiao(),
                giao.getDC(),
                giao.getTtGH().equals("0") ? "Đang Giao" : "Đã Giao",
                giao.getTtTT().equals("0") ? "Đã Thanh Toán" : "Chưa Thanh Toán",
                giao.getGhiChu()
            });
        }
    }
...
//        for (int i = 0; i < gh.getAllGH().size(); i++) {
//            PhieuGiaoHang go = gh.getAllGH().get(i);
//            if(go.getSDT().contains(sdt)){
//                lst.add(go);
//            }
//        }
////        if(lst.size()>0){
    ...
    private void locGH() {
        int loc = cboloc.getSelectedIndex();
        mol.setRowCount(0);
        for (PhieuGiaoHang giao : gh.selectByGH(loc)) {
            mol.addRow(new Object[]{
                giao.getMaGH(),
                giao.getSDT(),
                giao.getTenNV(),
